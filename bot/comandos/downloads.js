        ...
        switch(comandoSemPrefixo){      
            case "play":
                try{
                    ...
                    else if (resultadoInfoVideo.lengthSeconds > 360000) return await socket.responderTexto(c, id_chat, comandos_info.downloads.play.msgs.limite, mensagem)
            ...
            case "yt":
                try{
                    ...
                    else if(resultadoInfoVideo.lengthSeconds > 360000) return await socket.responderTexto(c, id_chat, comandos_info.downloads.yt.msgs.limite, mensagem)
            ...
            case "fb":
                try{
                    ...
                    if(resultadoFB.duration_ms > 360000) return await socket.responderTexto(c, id_chat, comandos_info.downloads.fb.msgs.limite, mensagem)
