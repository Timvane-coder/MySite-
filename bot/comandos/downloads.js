        ...
        switch(comandoSemPrefixo){      
            case "play":
                try{
                    ...
                    else if (resultadoInfoVideo.lengthSeconds > 50000) return await socket.responderTexto(c, id_chat, comandos_info.downloads.play.msgs.limite, mensagem)
            ...
            case "yt":
                try{
                    ...
                    else if(resultadoInfoVideo.lengthSeconds > 500000) return await socket.responderTexto(c, id_chat, comandos_info.downloads.yt.msgs.limite, mensagem)
