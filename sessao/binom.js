    ...
    generateDistributionTargetAnalysisSection() {
        ...
        if (target.probabilities) {
            data.push([
                ...
                { value: target.probabilities.exactly.toFixed(4), type: 'result' },
                { value: '', type: 'data' },
                { value: '', type: 'data' }
            ]);
            ...
            data.push([
                { value: 'P(X ≤ target):', type: 'label' },
                { value: target.probabilities.lessThanOrEqual.toFixed(4), type: 'result' },
                { value: '', type: 'data' },
                { value: '', type: 'data' }
            ]);
    ...
    generateConfidenceIntervalsSection() {
        ...
        Object.entries(this.confidenceIntervals).forEach(([level, ci]) => {
            ...
            data.push([
                ...
                { value: `[${ci.lowerBound}, ${ci.upperBound}]`, type: 'result' },
                { value: `Width: ${ci.width}`, type: 'data' },
