...
generateWorkbook() {
    ...
    data.push(...this.generateValidationSection()); // NEW
    data.push(...this.generateSampleDataSection());
    data.push(...this.generateBasicStatisticsSection());
    data.push(...this.generateRobustStatisticsSection()); // NEW
    ...
    data.push(...this.generateDistributionPropertiesSection()); // NEW
    ...
    // Advanced analyses sections (NEW)
    ...
    data.push(...this.generateAnalysisSummarySection()); // NEW
