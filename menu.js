...
// Add new enum for navigation views
var NavigationView;
(function (NavigationView) {
    NavigationView["Default"] = "Default";
    NavigationView["Settings"] = "Settings";
    NavigationView["Apps"] = "Apps";
    NavigationView["Weather"] = "Weather";
    NavigationView["Movies"] = "Movies";
...
// Enhanced QuickNav with click handlers
const QuickNav = () => {
    const { currentView, setCurrentViewTo } = React.useContext(AppContext);
    
    const getItems = () => {
        return [{
                id: 1,
                label: "Weather",
                view: NavigationView.Weather
            }, {
                id: 2,
                label: "Settings",
                view: NavigationView.Settings
            }, {
                id: 3,
                label: "Apps",
                view: NavigationView.Apps
            }, {
                id: 4,
                label: "Movies",
                view: NavigationView.Movies
            }].map((item) => {
            const handleClick = () => {
                setCurrentViewTo(item.view);
            };
            
            return (React.createElement("div", { 
                key: item.id, 
                className: `quick-nav-item clear-button ${currentView === item.view ? 'active' : ''}`,
                onClick: handleClick
            },
...
// New Android-style Settings component
const AndroidSettings = () => {
    const { setCurrentViewTo } = React.useContext(AppContext);
    
    const handleBackClick = () => {
        setCurrentViewTo(NavigationView.Default);
    };
    ...
    const getSettingsItems = () => {
        return [
            ...
            },
            {
                ...
                title: "Display",
                subtitle: "Brightness, theme, font size",
                category: "Display"
            },
            {
                id: 4,
                ...
                subtitle: "Ring volume, notification sounds",
                category: "Sound"
            },
            {
                id: 5,
            ...
            },
            {
                ...
                title: "Battery",
                subtitle: "85% - About 8 hours left",
                category: "Battery"
            },
            {
                id: 7,
                ...
                title: "Security",
                subtitle: "Screen lock, fingerprint, passwords",
                category: "Security"
            },
            {
                id: 8,
                ...
                title: "Privacy",
                subtitle: "Permissions, location, ads",
                category: "Privacy"
            },
            {
                id: 9,
                ...
                title: "Google",
                subtitle: "Backup, sync, Google services",
                category: "Google"
            },
            {
                id: 10,
                ...
                title: "System",
                subtitle: "Languages, time, backup",
                category: "System"
            }
        ].map((item) => {
            return (React.createElement("div", { key: item.id, className: "settings-item" },
                React.createElement("div", { className: "settings-item-icon" },
                    React.createElement("i", { className: item.icon })),
                React.createElement("div", { className: "settings-item-content" },
                    React.createElement("span", { className: "settings-item-title" }, item.title),
                    React.createElement("span", { className: "settings-item-subtitle" }, item.subtitle))));
        });
    };
    
    return (React.createElement(MenuSection, { 
        icon: "fa-solid fa-arrow-left", 
        id: "android-settings-section", 
        title: "Settings",
        scrollable: true
    },
        React.createElement("div", { className: "settings-header" },
            React.createElement("button", { className: "settings-back-button clear-button", onClick: handleBackClick },
                React.createElement("i", { className: "fa-solid fa-arrow-left" }),
                React.createElement("span", null, "Back"))),
        React.createElement("div", { className: "settings-content" }, getSettingsItems())));
};

// New Apps Grid component
const AppsGrid = () => {
    const { setCurrentViewTo } = React.useContext(AppContext);
    ...
    const getApps = () => {
        return [
            ...
            return (React.createElement("div", { key: app.id, className: "app-icon-container" },
                React.createElement("div", { className: "app-icon" },
                    React.createElement("i", { className: app.icon, style: iconStyle })),
    ...
    return (React.createElement(MenuSection, { 
        icon: "fa-solid fa-arrow-left", 
        id: "apps-grid-section", 
        title: "Apps"
    },
        React.createElement("div", { className: "apps-header" },
            React.createElement("button", { className: "apps-back-button clear-button", onClick: handleBackClick },
                React.createElement("i", { className: "fa-solid fa-arrow-left" }),
                React.createElement("span", null, "Back"))),
        React.createElement("div", { className: "apps-grid" }, getApps())));
};
...
const Menu = () => {
    ...
    const renderCurrentView = () => {
        switch (currentView) {
            case NavigationView.Settings:
                return React.createElement(AndroidSettings, null);
            case NavigationView.Apps:
                return React.createElement(AppsGrid, null);
            default:
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" }, renderCurrentView()))));
};
...
const App = () => {
    ...
    const [currentView, setCurrentViewTo] = React.useState(NavigationView.Default);
    
    const getStatusClass = () => {
        return userStatus.replace(/\s+/g, "-").toLowerCase();
    };
    return (React.createElement(AppContext.Provider, { value: { userStatus, setUserStatusTo, currentView, setCurrentViewTo } },
