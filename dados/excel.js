...
export class EnhancedSpreadsheetWorkbook {
    ...
    applyFormulaBatch(targetRange, formulaKey, paramTemplate) {
        ...
        // Handle row-wise operations (sumByRow, productByRow, averageByRow)
        if (['sumByRow', 'productByRow', 'averageByRow'].includes(formulaKey)) {
            ...
            try {
                ...
                if (tempFilePath && fs.existsSync(tempFilePath)) {
                    try {
                        ...
                        console.log(`  • Cleaned up: ${path.basename(tempFilePath)}`);
                    } catch (e) {
